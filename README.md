...
ระบบนี้ประกอบด้วยโหนดหลายตัวที่ร่วมกันรับผิดชอบในการจัดเก็บ key-value คู่ต่าง ๆ การกำหนด Owner ของ key จะใช้ **Hash Function (SHA-1)** เพื่อแปลง key เป็นค่าแฮช จากนั้นนำมาหาตำแหน่งของโหนดที่รับผิดชอบ
